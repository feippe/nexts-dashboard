...
"[project]/node_modules/.pnpm/next@15.6.0-canary.8_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-server-dom-turbopack-experimental/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function initializeModelChunk(chunk) {
        ...
        try {
            ...
            null !== resolveListeners && (chunk.value = null, chunk.reason = null, wakeChunk(resolveListeners, value, chunk));
    ...
    function initializeElement(response, element, lazyType) {
        ...
        lazyType && lazyType._store && lazyType._store.validated && !element._store.validated && (element._store.validated = lazyType._store.validated);
    ...
    function fulfillReference(reference, value, fulfilledChunk) {
        ...
        else reference.isDebug || transferReferencedDebugInfo(handler.chunk, fulfilledChunk, response);
        handler.deps--;
    ...
    function transferReferencedDebugInfo(parentChunk, referencedChunk, referencedValue) {
        referencedChunk = referencedChunk._debugInfo;
        if ("object" === typeof referencedValue && null !== referencedValue && (isArrayImpl(referencedValue) || "function" === typeof referencedValue[ASYNC_ITERATOR] || referencedValue.$$typeof === REACT_ELEMENT_TYPE)) {
            var existingDebugInfo = referencedValue._debugInfo;
            null == existingDebugInfo ? Object.defineProperty(referencedValue, "_debugInfo", {
                configurable: !1,
                enumerable: !1,
                writable: !0,
        ...
        if (null !== parentChunk) for(parentChunk = parentChunk._debugInfo, referencedValue = 0; referencedValue < referencedChunk.length; ++referencedValue)existingDebugInfo = referencedChunk[referencedValue], null == existingDebugInfo.name && parentChunk.push(existingDebugInfo);
    }
    function getOutlinedModel(response, reference, parentObject, key, map) {
        ...
        switch(id.status){
            case "fulfilled":
                for(var value = id.value, i = 1; i < reference.length; i++){
                    for(; value.$$typeof === REACT_LAZY_TYPE;){
                        ...
                        switch(value.status){
                            ...
                            case "blocked":
                            case "pending":
                                return waitForReference(value, parentObject, key, response, map, reference.slice(i - 1), !1);
                            case "halted":
                ...
                response = map(response, value, parentObject, key);
                (parentObject[0] !== REACT_ELEMENT_TYPE || "4" !== key && "5" !== key) && transferReferencedDebugInfo(initializingChunk, id, response);
                return response;
            case "pending":
            case "blocked":
                return waitForReference(id, parentObject, key, response, map, reference, !1);
            case "halted":
                return initializingHandler ? (parentObject = initializingHandler, parentObject.deps++) : initializingHandler = {
                    parent: null,
                    chunk: null,
    ...
    var React = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.6.0-canary.8_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-experimental/index.js [app-client] (ecmascript)"), ReactDOM = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.6.0-canary.8_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-dom-experimental/index.js [app-client] (ecmascript)"), decoderOptions = {
        stream: !0
...
"[project]/node_modules/.pnpm/next@15.6.0-canary.8_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-server-dom-turbopack-experimental/client.browser.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
;
    ...
    module.exports = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.6.0-canary.8_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-server-dom-turbopack-experimental/cjs/react-server-dom-turbopack-client.browser.development.js [app-client] (ecmascript)");
}
}),
"[project]/node_modules/.pnpm/next@15.6.0-canary.8_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-server-dom-turbopack-experimental/client.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

module.exports = __turbopack_context__.r("[project]/node_modules/.pnpm/next@15.6.0-canary.8_react-dom@19.1.0_react@19.1.0__react@19.1.0/node_modules/next/dist/compiled/react-server-dom-turbopack-experimental/client.browser.js [app-client] (ecmascript)");
}),
]);

//# sourceMappingURL=89c6a_next_dist_compiled_react-server-dom-turbopack-experimental_eab20cfd._.js.map